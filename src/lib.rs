...
//! this crate simplifies the process of working with different color spac
//! parts: color structs, and the color trait.                            
//!                                                                       
//! # structs                                                             
//!                                                                       
//! the structs in this module represent a color in a particular color spa
...
//! # the color trait                                                     
//!                                                                       
//! every color struct implements the color trait. the color trait ensures
//! implements it can be cast to all the colors. when writing functions th
//! using a generic color allows the caller to store their colors in whate
//! like.                                                                 
//!                                                                       
//! ```                                                                   
...
/// any struct that implements this trait must implement Into for all colo
/// module.                                                               
